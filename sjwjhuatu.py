...
plt.bar(range(1921,2021),b)
plt.xlabel("year")
plt.ylabel("number of music")
plt.title("number of music in different years")
plt.show()

plt.scatter(a15,y)
plt.xlabel("year")
plt.ylabel("popularity-modified")
plt.title("modifid popularity of year")
plt.show()

plt.scatter(a15,a11,color='green')
plt.xlabel("year")
plt.ylabel("popularity")
plt.title("popularity of year")
plt.show()
